...
export default function ModalEdit({
  ...
  return (
    <>
    <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Edit</button>
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <button id={id} onClick={editMedia}  type="button" className="btn btn-primary">Add Movie</button>
          </div>
            </form>
          </div>
        </div>
